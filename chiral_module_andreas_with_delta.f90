  ...
  subroutine init_chp_constants 
    ...
    if(chiral_delta_flag)then
       ...
       if(delta_chiral_order == NLO) then
          ...
          elseif(abs(lambda_delta - 450d0) < 1d-5 ) then
              c1s0(-1) = c1s0_input(-1) ! Ct_1S0pp   call chp_set_CIB_LO_contact(1, -1, -3.09893184381559994D-01) ! Ct_1S0pp 
              c1s0(0)  = c1s0_input(0)  ! Ct_1S0np   call chp_set_CIB_LO_contact(2, -1, -1.97950619113270027D-01) ! Ct_3S1pp 
              c1s0(1)  = c1s0_input(1)  ! Ct_1S0nn   call chp_set_CIB_LO_contact(1,  0, -3.10711872064980021D-01) ! Ct_1S0np 
              c3s1(-1) = c3s1_input(-1) ! Ct_3S1pp   call chp_set_CIB_LO_contact(2,  0, -1.97950619113270027D-01) ! Ct_3S1np 
              c3s1(0)  = c3s1_input(0)  ! Ct_3S1np   call chp_set_CIB_LO_contact(1,  1, -3.10510995610929985D-01) ! Ct_1S0nn 
              c3s1(1)  = c3s1_input(1)  ! Ct_3S1nn   call chp_set_CIB_LO_contact(2,  1, -1.97950619113270027D-01) ! Ct_3S1nn 
          
          elseif(abs(lambda_delta - 394d0) < 1d-5 ) then
             c1s0(-1) = c1s0_input(-1) ! Ct_1S0pp  call chp_set_CIB_LO_contact(1, -1, -3.09925223545309991D-01) ! Ct_1S0pp
             c1s0(0)  = c1s0_input(0)  ! Ct_1S0np  call chp_set_CIB_LO_contact(2, -1, -2.05462289226700012D-01) ! Ct_3S1pp
             c1s0(1)  = c1s0_input(1)  ! Ct_1S0nn  call chp_set_CIB_LO_contact(1,  0, -3.10751704075070023D-01) ! Ct_1S0np
             c3s1(-1) = c3s1_input(-1) ! Ct_3S1pp  call chp_set_CIB_LO_contact(2,  0, -2.05462289226700012D-01) ! Ct_3S1np
             c3s1(0)  = c3s1_input(0)  ! Ct_3S1np  call chp_set_CIB_LO_contact(1,  1, -3.10539966723270000D-01) ! Ct_1S0nn
             c3s1(1)  = c3s1_input(1)  ! Ct_3S1nn  call chp_set_CIB_LO_contact(2,  1, -2.05462289226700012D-01) ! Ct_3S1nn
          else
             write(6,*) "Error"
             stop
          end if
       ...
       if(delta_chiral_order == NNLO) then
          ...
          elseif(abs(lambda_delta - 394d0) < 1d-5 ) then
             c1s0(-1) = c1s0_input(-1)!-3.36845687915189984D-01 ! Ct_1S0pp call chp_set_CIB_LO_contact(1, -1, -3.36845687915189984D-01) ! Ct_1S0pp
             c1s0(0)  = c1s0_input(0) !-3.37854531334379982D-01 ! Ct_1S0np call chp_set_CIB_LO_contact(2, -1, -2.36959231730459990D-01) ! Ct_3S1pp
             c1s0(1)  = c1s0_input(1) !-3.37722607113270012D-01 ! Ct_1S0nn call chp_set_CIB_LO_contact(1,  0, -3.37854531334379982D-01) ! Ct_1S0np
             c3s1(-1) = c3s1_input(-1)!-2.36959231730459990D-01 ! Ct_3S1pp call chp_set_CIB_LO_contact(2,  0, -2.36959231730459990D-01) ! Ct_3S1np
             c3s1(0)  = c3s1_input(0) !-2.36959231730459990D-01 ! Ct_3S1np call chp_set_CIB_LO_contact(1,  1, -3.37722607113270012D-01) ! Ct_1S0nn
             c3s1(1)  = c3s1_input(1) !-2.36959231730459990D-01 ! Ct_3S1nn call chp_set_CIB_LO_contact(2,  1, -2.36959231730459990D-01) ! Ct_3S1nn
          else
    ...
    if(chiral_delta_flag)then
       ...
       if(delta_chiral_order == NLO) THEN
          ...
          elseif(abs(lambda_delta - 450d0) < 1d-5 ) then
             cnlo_pw(1) =  cnlo_pw_input(1)! C_1S0    call chp_set_NLO_contact(1,  2.39163813513152990D+00) ! C_1S0     
             cnlo_pw(2) =  cnlo_pw_input(2)! C_3P0    call chp_set_NLO_contact(2,  6.86901585796929948D-01) ! C_3P0     
             cnlo_pw(3) =  cnlo_pw_input(3)! C_1P1    call chp_set_NLO_contact(3,  4.81266565581999969D-03) ! C_1P1     
             cnlo_pw(4) =  cnlo_pw_input(4)! C_3P1    call chp_set_NLO_contact(4, -1.00011242015441004D+00) ! C_3P1    
             cnlo_pw(5) =  cnlo_pw_input(5)! C_3S1    call chp_set_NLO_contact(5,  5.58973150278149977D-01) ! C_3S1     
             cnlo_pw(6) =  cnlo_pw_input(6)! C_3S1-3D1call chp_set_NLO_contact(6,  3.62094234568600015D-01) ! C_3S1-3D1
             cnlo_pw(7) =  cnlo_pw_input(7)! C_3P2    call chp_set_NLO_contact(7, -8.08073350643100041D-01) ! C_3P2    
        ...
        if(delta_chiral_order ==  NNLO)then
           ...
           elseif(abs(lambda_delta - 394d0) < 1d-5 ) then
              cnlo_pw(1) = cnlo_pw_input(1)! 2.46900829544757006D+00 ! C_1S0     
              cnlo_pw(2) = cnlo_pw_input(2)! 6.16935689120689967D-01 ! C_3P0     
              cnlo_pw(3) = cnlo_pw_input(3)!-5.26929817733700068D-02 ! C_1P1     
              cnlo_pw(4) = cnlo_pw_input(4)!-1.09054771638107995D+00 ! C_3P1    
              cnlo_pw(5) = cnlo_pw_input(5)! 7.22641309492930040D-01 ! C_3S1     
              cnlo_pw(6) = cnlo_pw_input(6)! 3.75968068144939938D-01 ! C_3S1-3D1
              cnlo_pw(7) = cnlo_pw_input(7)!-8.76265471802940010D-01 ! C_3P2    
           else
              write(6,*) "ERROR wrong cutoff"
              stop
           end if
