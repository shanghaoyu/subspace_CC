...
class BaseConjugateProcess:
    ...
    def compute_scale_sq(cls, y, sqrt_R, basis, center0, disp0, df0, scale0, decomposition,
                         eval_gradient=False, dR=None, note=None):
        R"""The squared scale hyperparameter :math:`\tau^2` updated based on data.
        ...
        if eval_gradient:
            ...
            return scale_sq, d_scale_sq
        if note == 3.15:
            #print("They y=" +str(df0 * scale0 ** 2 ))
            #print("They basis=" +str(basis ))
            print("They V0=" +str(disp0 ))
            print("They V=" +str(disp ))
            #print("They inv(V0)=" +str(inv(disp0) ))
            print("They df0=" +str(df0 ))
            print("They df=" +str( df ))
            print("They c_bar_square=" +str(scale_sq*df/(df-2) ))
...
class ConjugateGaussianProcess(BaseConjugateProcess):
    ...
    def log_marginal_likelihood(self, theta=None, eval_gradient=False, X=None, y=None,note=None):
        ...
        if note == 3.15: 
            ...
            #print("They: R="+str(R))
            #print("They: y"+str(y))
            print("They: length_scale= "+str(theta))
            print("They: kernel_clone:"+str(kernel))
            #print("They: "+str(self.nugget))
        ...
        if note == 3.14:
            print("T1_0="+str(log_likelihood_dims))
        ...
        if note == 3.16:
            print("They y_train="+str(y_train)) 
            print("They mean="+str(mean)) 
            print("They alpha="+str(alpha)) 
            print("They df0="+str(df0)) 
            print("They df="+str(df)) 
            print("They var="+str(var)) 
            print("They df*scale^2="+str(df*scale2)) 
            print("T2 + T3="+str(-0.5*logdet_K-N / 2 * np.log(2 * np.pi))) 
            print("Tall="+str(log_likelihood)) 
            print("T1="+str(log_likelihood-  (-0.5*logdet_K-N / 2 * np.log(2 * np.pi)) )) 
...
class TruncationProcess:
    ...
    def fit(self, X, y, orders, dX=None, dy=None):
        ...
        self._fit = True
        #print("wttttttttttttttfffffff")
        #print("self.y_train_="+str(self.y_train_))
        #print("ratio="+str(ratio))
        #print("ref="+str(ref))
        #print("self.coeffs_="+str(self.coeffs_))
    ...
    def log_marginal_likelihood(self, theta, eval_gradient=False, X=None, y=None, orders=None, **ratio_kws):
        ...
        ## test
        #ratio = [0.39831432,0.52830516, 0.61420932, 0.68110791, 0.73694777] 
        ...
        #print("ratio="+str(ratio))
        #print("ref="+str(ref))
        #print("det_factor="+str(det_factor))
