...
saturation_density_batch, saturation_energy_batch, symmetry_energy_batch,L_batch,K_batch = io_1.generate_NM_observable_batch(ccd_pnm_batch_all,ccd_snm_batch_all,density_batch_all,"interpolation")
...
#     
#io_1.plot_3(saturation_density_batch,saturation_energy_batch,symmetry_energy_batch,K_batch,L_batch)
rskin_batch = io_1.read_rskin_data("./pb208_rskin.txt",validation_count,start_line=1,position=3)
print(rskin_batch)
