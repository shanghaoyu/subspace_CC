...
all_objects = ccm_modules_jwg.o chiral_module_andreas_with_delta.o ccm_library.o ccm_main_jwg.o ccm_iter_jwg_2.o ccm_energy.o ccm_t2_eqn.o ccm_diis.o ccm_mapping_jwg.o ccm_t3_channels.o ccm_triples_jwg.o ccm_t3_eqn.o ccm_t3full_channels_jwg.o ccm_v3nf_channels.o ccm_general_eigvalue.o minnesota_module.o IHS_sampling.o
