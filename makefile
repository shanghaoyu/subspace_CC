...
all_objects = ccm_modules.o chiral_module_andreas_with_delta.o ccm_library.o ccm_main_jwg.o ccm_iter_jwg_2.o ccm_energy.o ccm_t2_eqn.o ccm_diis.o ccm_mapping.o ccm_t3_channels.o ccm_triples.o ccm_t3_eqn.o ccm_t3full_channels.o ccm_v3nf_channels.o
